...
from aiogram.utils import executor
from aiogram.types import InlineKeyboardMarkup, InlineKeyboardButton
from aiogram.types import Update, CallbackContext
...
async def process_ask_question_callback(callback_query: types.CallbackQuery):
    ...
    await bot.send_message(
        ...
        text="Откройте мини-приложение для отправки вопроса:",
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton("Открыть мини-приложение", url="https://acqu1red.github.io/tgkprivate/")]
        ])
    )
